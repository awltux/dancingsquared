...
export function ssdProgramme(): Programme {
  return {
    ...
    level: 'ssd',
    sessions: [
      { name: 'Lesson 1', calls: ['Circle Left', 'Circle Left 1/4', 'Circle Left 1/2', 'Circle Left 3/4', 'Circle Right', 'Circle Right 1/4', 'Circle Right 1/2', 'Circle Right 3/4', 'Forward and Back', 'Heads Forward and Back', 'Sides Forward and Back', 'Dosado', 'Dosado to a Wave', 'Swing Your Partner', 'Swing Your Corner', 'All 4 Couples Promenade 1/4', 'All 4 Couples Promenade 1/2', 'All 4 Couples Promenade 3/4', 'All 4 Couples Promenade Full', 'Single File Promenade', 'All 4 Couples Wrong Way Promenade 1/4', 'All 4 Couples Wrong Way Promenade 1/2', 'All 4 Couples Wrong Way Promenade 3/4', 'All 4 Couples Wrong Way Promenade Full', 'Star Promenade', 'Allemande Left', 'Allemande Left in the Alamo Style', 'Turn Partner by the Right', 'Turn Partner by the Left', 'Left Arm Turn 3/4', 'Centers Arm Turn 3/4', 'Right and Left Grand', 'Weave the Ring', 'Wrong Way Grand', 'Left Hand Star', 'Right Hand Star', 'Right-Hand Star 1/4', 'Right-Hand Star 1/2', 'Right-Hand Star 3/4', 'Right-Hand Star a Full Turn', 'Left-Hand Star 1/4', 'Left-Hand Star 1/2', 'Left-Hand Star 3/4', 'Left-Hand Star a Full Turn', 'Courtesy Turn', 'Courtesy Turn and a Quarter More', 'Ladies Chain', 'Head Ladies Chain', 'Side Ladies Chain', 'Four Ladies Chain', 'Pass Thru', 'Wheel Around', 'Reverse Wheel Around', 'Heads Wheel Around'] },
      { name: 'Lesson 2', calls: ['Star Thru', 'Heads Star Thru', 'Slide Thru', 'Half Sashay', 'Heads Half Sashay', 'Sides Half Sashay', 'Rollaway', 'Ladies In, Men Sashay'] },
      { name: 'Lesson 3', calls: ['California Twirl', 'Bend the Line', 'Line of 8, Bend the Line', 'U-Turn Back', 'Boys Turn Back', 'Girls Turn Back', 'Girls Backtrack', 'Dive Thru'] },
      { name: 'Lesson 4', calls: ['Square Thru 2', 'Square Thru 3', 'Square Thru 4', 'Square Thru 1 1/2', 'Square Thru 2 1/2', 'Square Thru 3 1/2', 'Grand Square', 'Heads Face, Grand Square', 'Sides Face, Grand Square', 'Boys Face your Partner, Grand Square', 'Girls Face your Partner, Grand Square'] },
      { name: 'Lesson 5', calls: ['Lead Right', 'Lead Left', 'Heads Lead Right', 'Heads Lead Left', 'Sides Lead Right', 'Sides Lead Left', 'Veer Left', 'Veer Right', 'Circulate', 'Couples Circulate', 'Centers Circulate', 'Ends Circulate', 'All 8 Circulate', 'Box Circulate', 'Column Circulate', 'Split Circulate', 'Outer 6 Circulate', 'Trade', 'Couples Trade', 'Boys Trade', 'Girls Trade', 'Centers Trade', 'Ends Trade', 'Chain Down the Line'] },
      { name: 'Lesson 6', calls: ['Right and Left Thru', 'Heads Right and Left Thru and Back Away', 'Sides Right and Left Thru and Back Away', 'Right and Left Thru and a Quarter More', 'Flutterwheel', 'Reverse Flutterwheel', 'All 4 Women Lead Flutterwheel', 'All 4 Men Lead Reverse Flutterwheel', 'Sweep a Quarter Left', 'Sweep a Quarter Right', 'Flutterwheel and Sweep a Quarter', 'Reverse Flutterwheel and Sweep a Quarter', 'Recycle and Sweep a Quarter'] },
      ...
      { name: 'Lesson 8', calls: ['Step to a Wave', 'Heads Step to a Wave', 'Sides Step to a Wave', 'Step to a Left-Hand Wave', 'Dosado to a Wave', 'Allemande Left in the Alamo Style', 'Balance', 'Trade', 'Couples Trade', 'Boys Trade', 'Girls Trade', 'Centers Trade', 'Ends Trade', 'Swing Thru', 'Left Swing Thru', 'Boys Run', 'Girls Run', 'Centers Run', 'Ends Run', 'Centers Cross Run', 'Ends Cross Run'] },
      { name: 'Lesson 9', calls: ['Pass the Ocean', 'Heads Pass the Ocean', 'Sides Pass the Ocean', 'Extend', 'Zoom', 'Centers Zoom', 'Ends Zoom'] },
      { name: 'Lesson 10', calls: ['Centers In', 'Cast Off Three Quarters', 'Centers Cast Off Three Quarters', 'Very Centers Cast Off Three Quarters', 'Ferris Wheel', 'Partner Trade', 'Trade By'] },
      { name: 'Lesson 11', calls: ['Box the Gnat', 'Hinge', 'Centers Hinge', 'Couples Hinge', 'Very Centers Hinge', 'Touch a Quarter', 'Left Touch a Quarter', 'Touch a Half', 'All 8 Circulate', 'Circulate', 'Column Circulate', 'Centers Circulate', 'Ends Circulate', 'Tag the Line', '3/4 Tag the Line', 'Quarter Tag', 'Half Tag', 'Left Half Tag'] },
